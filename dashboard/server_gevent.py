...
def run_server():
    ...
    # SSL is always enabled - just load certificate paths
    try:
        ...
        if vars_path.exists():
            ...
            ssl_cert_path = getattr(vars_module, 'SSL_CERT_PATH', 'certs/cert.pem')
            ssl_key_path = getattr(vars_module, 'SSL_KEY_PATH', 'certs/key.pem')
    ...
    # SSL is always enabled - ensure certificate files exist
    protocol = "https"
    ...
    if not cert_file.exists() or not key_file.exists():
        ...
        print()
        print(f"   SSL certificates should be auto-generated by the launcher.")
        print(f"   If you see this error, try:")
        print(f"   1. Run: python3 launch-project-ape.py")
        print(f"   2. Or manually: python3 ssl_manager.py test")
        sys.exit(1)
